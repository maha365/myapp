...
import { SupperadminModule } from './supperadmin/supperadmin.module';
...
const routes: Routes = [
  ...
  { path: 'dashsupAdm', loadChildren: () => import('./supperadmin/supperadmin.module').then(m => SupperadminModule) },
